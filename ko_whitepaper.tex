...
\captionof{table}{3개 주문서를 포함하는 루프 주문}
		\label{fig:ring}
	\end{figurehere}
...
\begin{center}
	\begin{figurehere}
		...
		\captionof{table}{루프팅 프로토콜 거래 절차}
		\label{fig:process}
	\end{figurehere}
\end{center}
...
\begin{center}
	\begin{figurehere}
		...
		\captionof{table}{하위 루프를 포함하는 루프 주문}
		\label{fig:subring}
	\end{figurehere}
\end{center}
